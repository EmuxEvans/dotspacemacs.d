...
(when (spacemacs/system-is-mac)
  (spacemacs/set-leader-keys "op" 'zilongshanren/capture-screenshot))

(spacemacs/set-leader-keys "zi" 'spacemacs/zoom-frm-in)
(spacemacs/set-leader-keys "zo" 'spacemacs/zoom-frm-out)
(spacemacs/set-leader-keys "zz" 'spacemacs/zoom-frm-unzoom)
...
(spacemacs/set-leader-keys "fd" 'deft-find-file)
