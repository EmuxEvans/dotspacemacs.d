...
(setq zilongshanren-packages
      '(
        ...
        (kanban :location local)
        (function-args :location local)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      ...
      (add-hook 'org-babel-after-execute-hook 'zilongshanren/display-inline-images 'append)
                                        ; make babel results blocks lowercase
      (setq org-babel-results-keyword "results")
      (defun zilongshanren/display-inline-images ()
        (condition-case nil
...
;;
(defun zilongshanren/init-kanban ()
  "Initialize kanban"
  (use-package kanban
    :init
    (progn
      (message "start init kanban")
      (setq org-todo-keywords
            (quote ((sequence "BACKLOG(b) TODO(t)" "STARTED(s)" "QA(q)" "|" "DONE(d!/!)")
                    (sequence "WAITING(w@/!)" "SOMEDAY(S)"  "|" "CANCELLED(c@/!)" "MEETING(m)" "PHONE(p)"))))
...
(defun zilongshanren/init-cal-china-x ()
  "Initialize cal-china-x"
  (use-package cal-china-x
    :init
    (message "init cal-china-x")))
...
(defun zilongshanren/post-init-semantic ()
  (progn
...
(defun zilongshanren/post-init-ycmd ()
  (progn
    ...
    (set-variable 'ycmd-server-command `("python2.7", (expand-file-name "/Users/emuxevans/.vim/bundle/YouCompleteMe/third_party/ycmd/ycmd")))
    (set-variable 'ycmd-global-config "/Users/emuxevans/.vim/bundle/YouCompleteMe/third_party/ycmd/cpp/ycm/.ycm_extra_conf.py")
    (set-variable 'ycmd-extra-conf-whitelist '("/Users/emuxevans/workspace/project/leedarson/project/resos/*"))
...
(defun zilongshanren/init-function-args ()
  ...
  (use-package function-args
    ...
    (progn
      ...
      (message "init function-args"))))

(defun zilongshanren/post-init-auto-complete ()
  (progn
    (message "hello auto-completion")
...
(defun zilongshanren/post-init-deft ()
  ...
  (setq deft-extension '("md" "org"))
  (setq deft-directory "~/note/person"))
