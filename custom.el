...
(custom-set-variables
 ...
 '(safe-local-variable-values
   (quote
    ((eval progn
           (require
            (quote semantic))
           (message "resos locals")
           (semantic-add-system-include
            (concat default-directory "./trunk")
            (quote c++-mode))
           (semantic-add-system-include
            (concat default-directory "./trunk/include")
            (quote c++-mode))
           (semantic-add-system-include
            (concat default-directory "./trunk/apps")
            (quote c++-mode)))
     (eval progn
           (require
            (quote semantic))
           ...
           (semantic-add-system-include
            ...
            (quote c++-mode))
           (semantic-add-system-include
            (concat default-directory "./include")
            (quote c++-mode))
           (semantic-add-system-include
            (concat default-directory "./apps")
            (quote c++-mode)))
     (eval progn
           (require
            (quote grep))
     ...
     (eval progn
           (require
            (quote semantic))
           (message "load locals")
           (semantic-add-system-include "/Volumes/Transcend/workspace/security/libtomcrypt"
                                        (quote c++-mode))
           (semantic-add-system-include "/Volumes/Transcend/workspace/security/libtomcrypt/src/headers"
                                        (quote c++-mode))
           (semantic-add-system-include "/Volumes/Transcend/workspace/security/libtomcrypt/src/pk/dh"
                                        (quote c++-mode))
           (semantic-add-system-include "/Volumes/Transcend/workspace/security/libtomcrypt/testprof"
                                        (quote c++-mode)))
     (eval progn
           (require
            (quote grep))
 ...
 '(ycmd-extra-conf-whitelist (quote ("~/cocos2d-x/*")) t))
(custom-set-faces
